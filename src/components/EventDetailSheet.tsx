      ...
      <div className="grid gap-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 min-h-11.5 rounded-2xl border border-line bg-surface font-black text-ink transition hover:-translate-y-px active:translate-y-px active:scale-[0.98]"
          >
            Edit
          </button>
          <button
            ...
            className="flex-1 min-h-11.5 rounded-2xl border border-[#f0c8bd] bg-surface font-black text-[#b83f28] transition hover:-translate-y-px active:translate-y-px active:scale-[0.98]"
          >
            Delete
          </button>
        </div>
